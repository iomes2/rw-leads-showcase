...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RWX Media — Marketing for Trades" },
      ...
      { name: "author", content: "RWX Media" },
      { property: "og:title", content: "RWX Media — Marketing for Trades" },
      ...
      { name: "twitter:title", content: "RWX Media — Marketing for Trades" },
